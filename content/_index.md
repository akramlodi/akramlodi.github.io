...
- **SkillSync** — Software Engineer (AI), Singapore  
       *May 2025 — Aug 2025*  
       Developed an AI hiring platform that automates candidate screening and matching to improve recruitment efficiency.

- **Schedrix** — Code Analyst  
       *Sep 2024 — Dec 2024*  
       Implemented AI-driven analytics to analyze user behavior and predict churn risk, improving retention strategies.

- **Qrious (Rebranded ZoroTrack)** — Founder  
       *Jul 2021 — Dec 2021*  
       Created a QR-based lost-and-found system that stores owner contact info securely for safe item retrieval.
